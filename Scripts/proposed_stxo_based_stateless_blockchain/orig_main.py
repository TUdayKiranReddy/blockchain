import secrets
from helpfunctions import concat, generate_two_distinct_primes, hash_to_prime, bezout_coefficients, mul_inv, shamir_trick, calculate_product
...
def batch_delete_(A0, S, x_list, n):
    for x in x_list:
        del S[x]
    ...
    if len(S) == 0:
        ...
        return Anew     
n, A0, S = setup()
A, _ = batch_add(A0, S, [9, 3, 5, 7], n)
print(A, S)
A, _ = batch_delete(A, S, [3, 5, 7], n)
A1 = batch_delete_(A, S, [3, 5, 7], n)
print(A==A1)