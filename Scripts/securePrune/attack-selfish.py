...
for i in range(numminers):
	miners.append(Miner(i, hashrates[i] * 1.0/600.0, 200*1024,blocksize, seed_block, event_q, t))

# make the strong miner a bad miner
miners[i] = BadMiner(i, hashrates[i] * 1.0/600.0, 200*1024,blocksize, seed_block, event_q, t)
